...
contract RaffleTest is Test , CodeConstants{
    ...
    function setUp() external {
        ...
        if (block.chainid == LOCAL_CHAIN_ID) {
            ...
            VRFCoordinatorV2_5Mock(vrfCoodinator).fundSubscription(subscriptionId, LINK_BALANCE);
        }
    ...
    //forge test --match-test testCantEnterWhenRaffleIsCalculating   -vvvvv 可查看详情
  ...
  function testPerformUpkeepRevertsIfCheckUpkeepIsFalse() public {
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep() public  skipFork {
        ...
        VRFCoordinatorV2_5Mock(vrfCoodinator).fulfillRandomWords(0, address(raffle));

        vm.expectRevert(VRFCoordinatorV2_5Mock.InvalidRequest.selector);
        VRFCoordinatorV2_5Mock(vrfCoodinator).fulfillRandomWords(1, address(raffle));
    }
     ...
     function testFulfillRandomWordsPicksAWinnerResetsAndSendsMoney() public raffleEntered skipFork 
      {
        ...
        VRFCoordinatorV2_5Mock(vrfCoodinator).fulfillRandomWords(uint256(requestId), address(raffle));
